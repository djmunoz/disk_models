...
for k in range(0,INTERPOL_BINS):
  ...
  if (N_in_bin != 0):
    ...
    if(add_background) & (not load_mesh):
      ...
      zeropress_ind = press_back_at_R == 0
      #print press_back_at_R[zeropress_ind],dens_back_at_R[zeropress_ind],R_back_at_R[zeropress_ind],z_back_at_R[zeropress_ind],SOUNDSPEED_SQUARED_FLOOR,dens_back_at_R[zeropress_ind]*SOUNDSPEED_SQUARED_FLOOR
      ...
      if (k % 2 == 0): #only every other radial bin
        if (vertical_bins.max() < z_max):
          ...
          zeropress_ind = press_back_at_R == 0
          #print press_back_at_R[zeropress_ind],dens_back_at_R[zeropress_ind],R_back_at_R[zeropress_ind],z_back_at_R[zeropress_ind],SOUNDSPEED_SQUARED_FLOOR,dens_back_at_R[zeropress_ind]*SOUNDSPEED_SQUARED_FLOOR,dens_back_at_R[zeropress_ind]*vecSoundSpeedSquared(radius),local_density(radius,np.abs(z_back_at_R[zeropress_ind]))
