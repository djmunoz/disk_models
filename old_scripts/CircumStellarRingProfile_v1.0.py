...
def GasSigma(R):
  return MassCorrection *  SofteningCorrection * TruncationCorrection *\
      (SURFACE_DENSITY_FLOOR + M_disk/np.pi/R_disk**2/2.5172697922* np.exp(-(R-R_disk)**2/2/(0.18*R_disk)**2))
...
vecEffectiveGasSigma = InterpolatedUnivariateSpline(radius_per_bin,effective_gas_sigma,k=1)
