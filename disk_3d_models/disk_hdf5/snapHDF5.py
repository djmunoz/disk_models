...
def writeheader(f, header):	
	...
	group_header.__setitem__("NumPart_ThisFile",header.npart)
	group_header.__setitem__("NumPart_Total",header.nall)
	group_header.__setitem__("NumPart_Total_HighWord",header.nall_highword)
	group_header.__setitem__("MassTable",header.massarr)
	group_header.__setitem__("Time",header.time)
	group_header.__setitem__("Redshift",header.redshift)
	group_header.__setitem__("BoxSize",header.boxsize)
	group_header.__setitem__("NumFilesPerSnapshot",header.filenum)
        group_header.__setitem__("Omega0",header.omega0)
	group_header.__setitem__("OmegaLambda",header.omegaL)
        group_header.__setitem__("HubbleParam",header.hubble)	
	group_header.__setitem__("Flag_Sfr",header.sfr)	
	group_header.__setitem__("Flag_Cooling",header.cooling)
	group_header.__setitem__("Flag_StellarAge",header.stellar_age)
	group_header.__setitem__("Flag_Metals",header.metals)
	group_header.__setitem__("Flag_Feedback",header.feedback)
	group_header.__setitem__("Flag_DoublePrecision",header.double)
